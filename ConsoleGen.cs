...
public class ConsoleGen
{
	...
	public static ConsoleSystem.Command[] All = new ConsoleSystem.Command[]
	{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.completionFrameBudgetMs = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.entityMaxAge = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.entityMaxDistance = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.farPlane = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.height = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.layerMask = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.maxRaysPerFrame = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.maxRendersPerFrame = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.nearPlane = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.playerMaxDistance = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.playerNameMaxDistance = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.renderInterval = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.samplesPerRender = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.verticalFov = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CameraRenderer.width = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				ServerUsers.User[] array = Admin.Bans();
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				App.maxmessagesize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				...
				arg.ReplyWithObject(enumerable2);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				IEnumerable<Output.Entry> enumerable3 = ConVar.Console.search(arg);
				arg.ReplyWithObject(enumerable3);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				IEnumerable<Output.Entry> enumerable4 = ConVar.Console.tail(arg);
				arg.ReplyWithObject(enumerable4);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text3 = Demo.record(arg);
				arg.ReplyWithObject(text3);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text4 = Demo.stop(arg);
				arg.ReplyWithObject(text4);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text5 = Entity.svspawn(arg.GetString(0, ""), arg.GetVector3(1, Vector3.zero), arg.GetVector3(2, Vector3.zero));
				arg.ReplyWithObject(text5);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text6 = Entity.svspawngrid(arg.GetString(0, ""), arg.GetInt(1, 5), arg.GetInt(2, 5), arg.GetInt(3, 5));
				arg.ReplyWithObject(text6);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text7 = Entity.svspawnitem(arg.GetString(0, ""), arg.GetVector3(1, Vector3.zero));
				arg.ReplyWithObject(text7);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				object obj2 = ConVar.Manifest.PrintManifestRaw();
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.anticheatlog = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.arrowarmor = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.arrowdamage = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.artificialTemperatureGrowableRange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.authtimeout = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.bansServerFailureMode = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.bansServerTimeout = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.bleedingarmor = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.bleedingdamage = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.bulletarmor = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.bulletdamage = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.ceilingLightGrowableRange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.ceilingLightHeightOffset = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text8 = ConVar.Server.combatlog(arg);
				arg.ReplyWithObject(text8);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text9 = ConVar.Server.combatlog_outgoing(arg);
				arg.ReplyWithObject(text9);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.combatlogdelay = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.combatlogsize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.composterUpdateInterval = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.conveyorMoveFrequency = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.corpsedespawn = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.crawlingmaximumhealth = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.crawlingminimumhealth = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.cycletime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.debrisdespawn = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.defaultBlueprintResearchCost = str.ToInt(0);
			},
			Default = "10"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.encryption = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.entitybatchsize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.entitybatchtime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.entityrate = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.funWaterDamageThreshold = str.ToFloat(0f);
			},
			Default = "0.8"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.funWaterWetnessGain = str.ToFloat(0f);
			},
			Default = "0.05"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.idlekick = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.idlekickadmins = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.idlekickmode = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.incapacitatedrecoverchance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.industrialCrafterFrequency = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.industrialFrameBudgetMs = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.ipQueriesPerMin = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.itemdespawn = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.itemdespawn_container_scale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.itemdespawn_quick = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.max_sleeping_bags = str.ToInt(0);
			},
			Default = "15"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxclientinfosize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxconnectionsperip = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxdecryptqueuebytes = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxdecryptqueuelength = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxdecryptthreadwait = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maximumMapMarkers = str.ToInt(0);
			},
			Default = "5"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maximumPings = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxItemStacksMovedPerTickIndustrial = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxmainthreadwait = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxpacketsize_command = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxpacketspersecond = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxpacketspersecond_command = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxpacketspersecond_rpc = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxpacketspersecond_rpc_signal = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxpacketspersecond_tick = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxpacketspersecond_voice = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxpacketspersecond_world = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxplayers = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxreadqueuebytes = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxreadqueuelength = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxreadthreadwait = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxreceivetime = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxunack = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxwritequeuebytes = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxwritequeuelength = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.maxwritethreadwait = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.meleearmor = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.meleedamage = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.metabolismtick = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.modifierTickRate = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.netcachesize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text10 = ConVar.Server.netprotocol(arg);
				arg.ReplyWithObject(text10);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.nonPlanterDeathChancePerTick = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.optimalPlanterQualitySaturation = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.pingDuration = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.planttick = str.ToFloat(0f);
			},
			Default = "60"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.planttickscale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.playertimeout = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.port = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text13 = ConVar.Server.printeyes(arg);
				arg.ReplyWithObject(text13);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text14 = ConVar.Server.printpos(arg);
				arg.ReplyWithObject(text14);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text15 = ConVar.Server.printreadqueue(arg);
				arg.ReplyWithObject(text15);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text16 = ConVar.Server.printrot(arg);
				arg.ReplyWithObject(text16);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text17 = ConVar.Server.printwritequeue(arg);
				arg.ReplyWithObject(text17);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.queriesPerSecond = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.queryport = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text18 = ConVar.Server.readcfg(arg);
				arg.ReplyWithObject(text18);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.respawnresetrange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.rewounddelay = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text19 = ConVar.Server.rpclog(arg);
				arg.ReplyWithObject(text19);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.salt = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.saveBackupCount = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.savecachesize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.saveinterval = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.schematime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.seed = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.sprinklerEyeHeightOffset = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.sprinklerRadius = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.tickrate = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.updatebatch = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.updatebatchspawn = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.worldsize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.woundedmaxfoodandwaterbonus = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Server.woundedrecoverchance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Voice.voiceRangeBoostAmount = str.ToFloat(0f);
			},
			Default = "50"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.ocean_scale = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.ocean_time = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Drone.altitudeSpeedOverride = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Drone.maxControlRange = str.ToFloat(0f);
			},
			Default = "250"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Drone.movementSpeedOverride = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				EventScheduleWipeOffset.hoursBeforeWipeRealtime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string text20 = SteamNetworking.steamstatus();
				arg.ReplyWithObject(text20);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "tugboat_corpse_seconds",
			Parent = "tugboat",
			FullName = "tugboat.tugboat_corpse_seconds",
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => Tugboat.tugboat_corpse_seconds.ToString(),
			SetOveride = delegate(string str)
			{
				Tugboat.tugboat_corpse_seconds = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WipeTimer.daysToAddTest = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WipeTimer.hoursToAddTest = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WipeTimer.wipeDayOfWeek = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				WipeTimer.wipeHourOfDay = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
